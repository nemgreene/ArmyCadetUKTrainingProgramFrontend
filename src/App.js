...
<Route  path="training-table" element={
    <ProtectedRoute redirectPath="/" isAllowed={!!user && str?.includes('Comander')||str?.includes('Parent')||str?.includes('Cadet')||str?.includes('Instructor') }>
      <TrainingTable />
    </ProtectedRoute>  } />
<Route  path="lessons-table" element={
    <ProtectedRoute redirectPath="/" isAllowed={!!user && str?.includes('Comander')||str?.includes('Cadet')||str?.includes('Instructor') }>
      <LessonsTable />
    </ProtectedRoute>  } />
<Route path="role"  element={
    <ProtectedRoute redirectPath="/" isAllowed={!!user && str?.includes('Comander')} >
...
<Route path="comander" element={
    <ProtectedRoute redirectPath="/" isAllowed={!!user && str?.includes('Comander')} >
        <CommanderLessons  handleEditClick={(id) => {handlesessionEditClick(id);  }} />
    </ProtectedRoute> } />
